...
const Status = props => {
    ...
    const triggerSearch = () => {        
        axios.post(API_URL + '/Status/search', { name: search }).then(result => {           
            dispatch({ type: 'SET_DATA', payload: result.data.result });
        });
    }
    ...
    const triggerSave = async () => {
        ...
        if (name) {
            ...
            if (isEdit) { //modify
                await axios.put(API_URL + '/Status/' + isEdit, form).then(result => response = result);
                msg = "Successfully modified!";
            } else { //new Entry
                await axios.post(API_URL + '/Status/', form).then(result => response = result);
    ...
    const triggerConfirmedYes = () => {
        ...
        axios.delete(API_URL + '/Status/' + recordId).then(result => {
