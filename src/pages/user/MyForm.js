                ...
                <Modal.Body>
                    ...
                    <Form id="frmMyForm" onSubmit={(e)=>props.triggerSave(e)}>
                                    ...
                                    <Row>
                                        <Col className="col-12 col-md-6">
                                            <Form.Group className="mb-3" >
                                                ...
                                                <Form.Control name="password" type="password" value={props.form.password} onChange={props.triggerInputChange} required />
                                            </Form.Group>
                                        </Col>
                                        <Col className="col-12 col-md-6">
                                            <Form.Group className="mb-3" >
                        ...
                        <Row>
                            <Col className="col-12 col-md-6">
                                <Form.Group className="mb-3" >
                                    <Form.Label className="text-start ">Role <i className="text-danger">*</i></Form.Label>
                                    <Form.Select
                                        name="role" 
                            ...
                            <Col className="col-12 col-md-6">
                                <Form.Group className="mb-3" >
                                    <Form.Label className="text-start ">Status <i className="text-danger">*</i></Form.Label>
                                    <Form.Select
                                        name="status" 
